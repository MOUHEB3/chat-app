...
export default function IncomingCall({ active, incomingOffer }) {
  ...
  return (
    <div
      className={`${
        active ? "flex" : "hidden"
      } fixed inset-0 items-center justify-center bg-black bg-opacity-70 z-50 transition-opacity duration-300`}
    >
      <div className="bg-white dark:bg-backgroundDark3 dark:text-slate-200 rounded-lg p-6 shadow-2xl text-center transition-transform transform">
